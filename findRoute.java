// to compile do from folder above - C:\JobTests\GenTrack>javac -cp ../ findRoute.java
// to execute from same folder  - C:\JobTests\GenTrack>java -cp ../ Gentrack.findRoute
...
public class findRoute
{
	...
	public getRoute reverseAlongX(getRoute gr, char ver) {
		...
		char right = gr.get2dArray(row,col+1);
		char left = gr.get2dArray(row,col-1);
		char up = gr.get2dArray(row-1,col);
		char down = gr.get2dArray(row+1,col);
	...
	// new start pos's the elements of the 2darray are set to X
	...
	// is returned, if ok the startroute is called which processes the array
		...
		findRoute fr = new findRoute();
		char[][] xx = fr.readFile("example.txt");
		if (xx != null){
			System.out.println("Processing example.txt");
			fr.startRoute(xx);
		}

		xx = fr.readFile("fail.txt");
		if (xx != null){
			System.out.println("Processing fail.txt");
			fr.startRoute(xx);
		}

		xx = fr.readFile("input.txt");
		if (xx != null){
			System.out.println("Processing input.txt");
			fr.startRoute(xx);
		}

		xx = fr.readFile("medium_input.txt");
		if (xx != null){
			System.out.println("Processing medium_input.txt");
			fr.startRoute(xx);
		}

		xx = fr.readFile("sparse_medium.txt");
		if (xx != null){
			System.out.println("Processing sparse_medium.txt");
			fr.startRoute(xx);
		}

		xx = fr.readFile("small.txt");
		if (xx != null){
			System.out.println("Processing small.txt");
			fr.startRoute(xx);
		}

		xx = fr.readFile("large_input.txt");
		if (xx != null){
			System.out.println("Processing large_input.txt");
			fr.startRoute(xx);
		}
    	}
